...
import ViewUserDetailBasic from './ViewUserDetailBasic';
import ViewUserDetailStory from './ViewUserDetailStory';
...
class ViewUserDetail extends React.Component {
    ...
    async componentDidMount() {
        try {
            ...
            // get info user info
            let userInfo = await getUserById(_id);
            if(Number(userInfo.message) === 404) {
                this.props.history.push("/404");
            }
            // get questions
            let yourQuestions = await getYourQuestions(_id);
            // get  blogs
            let yourBlogs = await getYourBlogs(_id);
            ...
            <div id="content">
                ...
                <div className="main-head">
                    ...
                    <div id="mainbar" className="subtag mt36">
                        <div id="tag-profile">
                            <ViewUserDetailBasic userPayload={userPayloadInfo}/>
                        </div>
                        ...
                        <ViewUserDetailStory userPayload={userPayloadInfo}/>
                    ...
                    <div id="sidebar">
                        ...
                        <div className="profile-user--about mb16 mt36 bs-md p20">
                            <h3 className="mb24">QUESTIONS</h3>
                            <ul>
                                <li className="mb12">
                                    {
                                        questions.map( (q, i) => {
